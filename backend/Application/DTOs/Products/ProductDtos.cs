...
namespace Application.DTOs.Products
{
    ...
    /// <param name="PageMetadata">The SEO metadata for the product.</param>
    public record ProductReadDto(
        ...
        string? CategoryName,
        decimal Price,
        PageMetadataReadDto? PageMetadata
    );
    ...
    /// <param name="PageMetadata">The updated SEO metadata.</param>
    public record ProductCreateDto(
        string Name,
        List<string>? TagNames,
        string CategoryName,
        decimal Price,
        PageMetadataCreateDto? PageMetadata
    );
    ...
    /// <param name="PageMetadata">Specific SEO metadata fields to update.</param>
    public record ProductUpdateDto(
        string? Name,
        List<string>? TagNames,
        string? CategoryName,
        decimal? Price,
        PageMetadataUpdateDto? PageMetadata
    );
}
